...
using { anubhav.db.master, anubhav.db.transaction } from './datamodel1';

context CDSViews {
//define view abs->converts to ABS
//so we use ! [] to maintain exact case sentivity
    ...
    select from master.product{
        //The annotation provides localized labels for the field.
        @EndUserText.label:[
            {
                language: 'EN',
                text: 'Product id'
